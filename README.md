...
For this i have use the sqlite database db name is first and tables like for user table is auth1 and books table is books this is the simple code any one can use
